...
function Header() {
  ...
  const auth = useAuth()
  const { notifications, unreadCount, toastNotification, markAllRead, markGroupRead } = useChatNotification()
  ...
  return (
      <>
        ...
        {toastNotification && (
            <div
                onClick={() => {
                  markGroupRead(toastNotification.groupId)
