    ...
    >
      {running ? (
        <Canvas
          ...
          camera={{ position: [0, 4.2, 7.2], fov: 42, near: 0.1, far: 40 }}
      ...
      {running ? (
        <div className="pointer-events-none absolute left-1/2 top-[76%] z-[2] -translate-x-1/2 -translate-y-full">
          <GoCatRoomOverlay
            key={equipKey}
            growthStage={growthStage}
      ...
      {hint ? (
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-[3] bg-gradient-to-t from-black/30 to-transparent px-3 py-2 text-center">
