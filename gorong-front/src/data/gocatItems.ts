...
/** public/icon/*_aligned.png — 420×420 정렬 overlay */
export const GOCAT_ITEMS: GoCatItem[] = [
  { id: "witch_hat", name: "마녀 모자", category: "HEAD", imageUrl: "/icon/witch_hat_aligned.png" },
  { id: "crown", name: "왕관", category: "HEAD", imageUrl: "/icon/crown_aligned.png" },
  { id: "blue_cap", name: "파란 캡모자", category: "HEAD", imageUrl: "/icon/blue_cap_aligned.png" },
  { id: "pink_bow", name: "목 리본", category: "ACCESSORY", imageUrl: "/icon/pink_bow_neck_aligned.png" },
  {
    id: "round_glasses",
    name: "동그란 안경",
    category: "ACCESSORY",
    imageUrl: "/icon/round_glasses_aligned.png",
  },
];
