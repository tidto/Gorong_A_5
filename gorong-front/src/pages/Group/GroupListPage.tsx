                  ...
                  >
                    ...
                    <div style={{ padding: '14px 16px' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '8px', marginBottom: '6px' }}>
                        ...
                        <span style={{
                          fontSize: '14px', fontWeight: '800', color: isClosed ? '#94a3b8' : '#1a1a1a',
                          overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '240px',
                        }}>
                          {group.title}
                        </span>
                            {canEdit && <span style={{ fontSize: '10px', backgroundColor: '#fff4ed', color: '#ff8a3d', padding: '1px 6px', borderRadius: '6px', fontWeight: '700', flexShrink: 0 }}>내 글</span>}
                            {isJoined && !canEdit && <span style={{ fontSize: '10px', backgroundColor: '#ecfdf5', color: '#10b981', padding: '1px 6px', borderRadius: '6px', fontWeight: '700', flexShrink: 0 }}>참여중</span>}
                            {urgent && <span style={{ fontSize: '10px', backgroundColor: '#fff4ed', color: '#ff5e00', padding: '1px 6px', borderRadius: '6px', fontWeight: '800', flexShrink: 0 }}>마감임박</span>}
                          </div>
                        </div>
                        {/* 상태 뱃지 */}
                        <span style={{
                      ...
                      {/* 메타 정보 */}
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '11px', color: '#8c8c8c', flexWrap: 'wrap', marginBottom: '10px' }}>
                        {group.location && <span>📍 {group.location}</span>}
                        {group.meetingDate && (
                            <span style={{ color: isPassed ? '#cbd5e1' : '#8c8c8c' }}>
                        📅 {group.meetingDate}
                      </span>
                        )}
                        {group.event && (
                            <span style={{ backgroundColor: '#f8f8f5', border: '1px solid #ebe8e3', padding: '1px 7px', borderRadius: '6px' }}>
                        🎟️ {group.event}
                      </span>
                        )}
                        {/* 호스트 */}
                      ...
                      호스트&nbsp;
                          {group.author?.id
                              ? <button type="button" onClick={e => handleGoToHost(e, group)}
                                        style={{ border: 'none', background: 'transparent', padding: 0, color: '#ff8a3d', fontWeight: '700', cursor: 'pointer', fontSize: '11px', textDecoration: 'underline', textUnderlineOffset: '2px' }}>
                                {group.authorName || '익명'}
                              </button>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <div style={{ flex: 1, height: '4px', backgroundColor: '#f1f0ec', borderRadius: '99px', overflow: 'hidden' }}>
                          <div style={{
