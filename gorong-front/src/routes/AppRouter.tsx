...
//
//                     {/* 행사 상세: 비로그인도 볼 수 있게 ProtectedRoute 제거 */}
//                     <Route path="/events/:id" element={<EventDetail />} />
//
//                     <Route path="/events/:id/join" element={<ProtectedRoute><GroupJoin /></ProtectedRoute>} />
...
//                     <Route path="/minihome" element={<ProtectedRoute><MiniHome /></ProtectedRoute>} />
